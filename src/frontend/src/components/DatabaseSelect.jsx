...
export default function DatabaseSelect({ engine, version, onChange, caption = true }) {
  const { data: catalog = [] } = useQuery({ queryKey: ['databases'], queryFn: fetchDatabases, staleTime: 5 * 60_000 })
