...
func (s *swarmRunner) refresh() error {
	...
	content, err := composegen.GenerateRouted(s.cfgBytes, s.opts.Env, composegen.RouteOpts{BaseDomain: s.opts.BaseDomain, AutoURLMode: s.opts.AutoURLMode, AutoURLHost: s.opts.AutoURLHost, DNSProvider: s.opts.DNSProvider, OverrideCert: s.opts.OverrideCert, EnvFile: readDotenv(s.envDir)})
	if err != nil {
